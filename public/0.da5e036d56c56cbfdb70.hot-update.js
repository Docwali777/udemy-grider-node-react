...
exports.handleToken = exports.fetchUser = undefined;
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return _axios2.default.get('/api/callback_user');
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return _axios2.default.post('/api/stripe', token);

            case 2:
              res = _context2.sent;


              dispath({ type: '', payload: res.data });
